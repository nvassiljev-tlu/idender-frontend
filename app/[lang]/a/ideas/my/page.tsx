...
export default function MyIdeasPage() {
  ...
  return (
    <div className="min-w-[320px] flex flex-col items-center justify-start min-h-screen bg-slate-500 text-white font-sans px-4 py-8 break-words">
      ...
      <div className="w-full max-w-2xl bg-slate-600 p-6 rounded-lg shadow space-y-4">
        ...
        {!isLoading && ideas.map((idea) => (
          <div 
            ...
            <h2 className="text-lg font-semibold break-all">{idea.title}</h2>
            <p className="text-sm text-slate-300 mb-2 break-all">{idea.description}</p>
